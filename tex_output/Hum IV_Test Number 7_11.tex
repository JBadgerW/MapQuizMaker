...
\newcommand{\wstitle}{Test Number 7}
\newcommand{\wsVer}{11}
\newcommand{\Instructions}{Identify the location marked on the map.}
...
\begin{tikzpicture}
    ...
    \node at (3.0, 8.1) {\textbf{1}};
\node at (12.1, 11.3) {\textbf{2}};
\node at (7.9, 7.1) {\textbf{3}};
\node at (5.7, 5.3) {\textbf{4}};
\node at (9.9, 1.3) {\textbf{5}};
\node at (5.7, 6.6) {\textbf{6}};
...
\question\MatchQuestion{Mycenaea}{} \vfill
\end{multicols}
