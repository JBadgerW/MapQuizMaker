...
\newcommand{\wstitle}{Test Number 10}
\newcommand{\wsVer}{14}
\newcommand{\Instructions}{Just do it now!}
...
\begin{tikzpicture}
    ...
    \node at (5.7, 5.2) {\textbf{1}};
\node at (3.0, 8.1) {\textbf{2}};
\node at (10.0, 1.2) {\textbf{3}};
\node at (5.7, 6.4) {\textbf{4}};
\node at (12.4, 11.4) {\textbf{5}};
\node at (8.0, 7.1) {\textbf{6}};
